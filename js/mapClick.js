function mapClick() {
  app.view.on('click', function (event) {
    ...
    var activeLayer = app.layerMap[parseInt(app.obj.hucLayer)];
    if (!activeLayer) return;
    var query = activeLayer.createQuery();
    ...
    activeLayer.queryFeatures(query).then(function (response) {
      ...
      if (response.features[0]) {
        ...
        let TN_farm = a.TN_farm != null ? a.TN_farm.toFixed(1) : 'N/A';
        let TP_farm = a.TP_farm != null ? a.TP_farm.toFixed(1) : 'N/A';
        let SOVI = a.SOVI != null ? a.SOVI.toFixed(3) : 'N/A';
